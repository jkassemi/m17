...
Next steps
- Approve staleness and lateness defaults.
- Approve tick-size rule sources and fallback strategy.
- I will then produce per-team specs with acceptance criteria, detailed API contracts, and test vectors for:
  - ws-source + scheduler
  - nbbo-cache
