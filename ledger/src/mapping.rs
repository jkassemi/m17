...
/// Minute-aligned batch of trades written by `trade-engine`.
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Minute-aligned batch of quotes/NBBO samples.
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Greeks overlay materialized per symbol+minute.
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Rolling aggregate statistics (1m/5m/… windows) anchored to the window start minute.
#[derive(Clone, Debug, Serialize, Deserialize)]
