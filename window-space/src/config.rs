...
#[deprecated(
    since = "0.1.0",
    note = "LedgerConfig has been renamed to WindowSpaceConfig; update imports to window_space::WindowSpaceConfig"
)]
pub type LedgerConfig = WindowSpaceConfig;
